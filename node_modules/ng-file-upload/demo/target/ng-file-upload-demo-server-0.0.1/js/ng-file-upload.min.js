...
i.onload=function(){try{h.width=g>4?i.height:i.width,h.height=g>4?i.width:i.height;var b=h.getContext("2d");c(b,g,i.width,i.height),b.drawImage(i,0,0);var j=h.toDataURL(a.type||"image/WebP",.934);f["0th"][piexif.ImageIFD.Orientation]=1,j=piexif.insert(piexif.dump(f),j);var k=d.dataUrltoBlob(j,a.name);e.resolve(k)}catch(l){e.reject(l)}},i.onerror=function(a){e.reject(a)},i.src=b},function(a){e.reject(a)}),e.promise},d}]);